...
//############################################################################################################################//
    ...
    override func viewDidLoad() {
        ...
        //Calls loginButtonTapped() when it is tapped
...
//############################################################################################################################//
    ...
    override func viewDidLayoutSubviews () {
        ...
        passwordTextField.frame = CGRect (x: 30, y: emailTextField.bottom+15, width: scrollView.width-60,
                                          height: 52)
        loginButton.frame = CGRect (x: 30, y: passwordTextField.bottom+15, width: scrollView.width-60,
                                    height: 52)
        registerButton.frame = CGRect (x: 50, y: loginButton.bottom+15, width: scrollView.width-100,
                                       height: 44)
    }
